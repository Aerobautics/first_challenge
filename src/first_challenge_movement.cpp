...
int main(int argc, char **argv)
{
	...
	std::cout << "Debug point 1 reached." << std::endl;
	...
	std::cout << "Debug point 2 reached." << std::endl;
	...
	std::cout << "Debug point 3 reached." << std::endl;
	...
	std::cout << "Debug point 4 reached." << std::endl;
